...
def main_iptal(target: str, mode: str):
    ...
    with mp.Pool(processes=cpu_count, initializer=init_morphology) as pool:
        
        # TEK MERKEZİ KÜME (SET): Tüm kesin adayları burada toplayacağız.
        final_candidates = set()
        
        # ... (Dosya listeleme lojiği aynı kalır) ...
        ...
        for file_path in all_files_to_process:
            ...
            # --- ÖNEMLİ DÜZELTME: ARALIKLI YAZMA KALDIRILDI ---
            # Dosyaya yazma işlemi artık bu döngünün içinde yapılMAYACAKTIR.
            # ---------------------------------------------------

        print("\n--- İşlem Tamamlandı ---")
        
    # 3. Sonuçları Dosyalara Kaydet (Döngü bittikten sonra tek seferlik yazma)
    sonuclari_kaydet(final_candidates, KESIN_TURKCE_CIKTI)

    print("\n--- Nihai Özet ---")
    print(f"İşlenen Toplam Dosya Sayısı: {len(all_files_to_process):,}")
